...
DATA_ROOT=$PROJECT_ROOT/dataset/cosmetics/
...
# output
OUTPUT=$PROJECT_ROOT/cosmetics/${MODEL_TYPE}_reinit${REINIT}_begin${BEGIN_STEP}_period${PERIOD}_${LABEL_MODE}_hp${HP_LABEL}_${EPOCH}_${LR}/
